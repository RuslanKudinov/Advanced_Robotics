...
![Результаты A*](HW5/path_planning_results/astar_full_visualization.png)
...
![Результаты RRT](HW5/path_planning_results/rrt_full_visualization.png)
...
![Результаты RRT*](HW5/path_planning_results/rrt_star_full_visualization.png)
...
![Сравнение алгоритмов](HW5/path_planning_results/all_algorithms_comparison.png)
*Сравнение всех трех алгоритмов со сглаженными путями*

### Диаграммы метрик

![Сравнение метрик](HW5/path_planning_results/metrics_barcharts.png)
...
### A* Исследование
<video src="HW5/path_planning_results/astar_animation.mp4" controls width="100%"></video>
*A* систематически исследует сетку для поиска оптимального пути*

### RRT Построение дерева
<video src="HW5/path_planning_results/rrt_animation.mp4" controls width="100%"></video>
*RRT случайным образом расширяет дерево в сторону неисследованных областей*

### RRT* Оптимизация
<video src="HW5/path_planning_results/rrtstar_animation.mp4" controls width="100%"></video>
