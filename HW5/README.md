...
- **Свободное пространство:** 86.4% 
- **Препятствия:** 13.6% 
- **Стартовая точка:** (10, 10) - левый нижний угол
- **Целевая точка:** (90, 90) - правый верхний угол
...
### A* Исследование
[▶️ Смотреть анимацию A*](path_planning_results/as.mp4)
...
[▶️ Смотреть анимацию RRT](path_planning_results/rrt.mp4)
...
### RRT* Оптимизация
[▶️ Смотреть анимацию RRT*](path_planning_results/rrts.mp4)
