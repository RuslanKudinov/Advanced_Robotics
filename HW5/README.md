...
### A* Исследование
<video src="path_planning_results/astar_animation.mp4" controls width="100%"></video>
*A* систематически исследует сетку для поиска оптимального пути*

### RRT Построение дерева
<video src="path_planning_results/rrt_animation.mp4" controls width="100%"></video>
*RRT случайным образом расширяет дерево в сторону неисследованных областей*

### RRT* Оптимизация
<video src="path_planning_results/rrtstar_animation.mp4" controls width="100%"></video>
